 ...
 *
 * Guessed: `locateItinerary` matches the location text against a list of known
 * places, and when that fails it returns the centre of the province — which
 * can be tens of kilometres out, and is wrong in the same way on the wizard's
 * map, in the driving order, in the distances and in the PDF.
 */
